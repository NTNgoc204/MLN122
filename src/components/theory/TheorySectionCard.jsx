...
function TheorySectionCard({ section, index, MotionArticle, motionVariant }) {
  ...
  return (
    <MotionArticle
      ...
      className="group relative overflow-hidden rounded-[30px] bg-white/80 p-5 shadow-[0_14px_32px_rgba(13,55,89,0.11)] backdrop-blur-md sm:p-7"
    >
      <div
      ...
      <div className="relative">
        ...
        {renderSectionContent(section.id, section.title)}
      </div>
    </MotionArticle>
  );
}
